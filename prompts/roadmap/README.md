...
> RFC-020…029". A coluna "Depende de" abaixo marca com ✔ o que já está satisfeito. **Duas
> exceções, ambas na RFC-021 e ambas do proprietário:** o **rearme automático condicionado (D3,
> P1) NÃO foi aprovado** — o rearme segue manual, não implemente D3 — e o **rearme manual do
> kill switch (P2)** segue pendente, engatado desde 02/09 02:21:05Z. Aprovação de RFC não é
> ordem de implementar já: a ordem abaixo continua valendo e todo prompt re-mede antes de codar.
...
| 12 | [RFC-020 — deploy que não derruba o banco](12-rfc-020-deploy.md) | RFC (4 PRs) | 11 ✔; DP1/DP2 aprovadas ✔ | pendente |
| 13 | [RFC-021 — silêncio do feed com conexões vivas e kill switch honesto](13-rfc-021-feed-kill-switch.md) | RFC (3 PRs) | 12 em produção; **P1 (rearme automático) NÃO aprovado — D3 fora do escopo; o rearme manual é decisão aberta do proprietário** | pendente |
