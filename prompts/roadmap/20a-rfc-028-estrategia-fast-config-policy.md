...
| Dependências PR-0, RFC-022, RFC-025 | **PR-0 implementado e verificado em produção** (PRs #93, #94, #96, 04/09); RFC-022 e RFC-025 em **`accepted`** e **ainda não implementadas** (`RFC-022…:3`, `RFC-025…:3`) | PR-0: `count(*) FROM paper_ledger_events WHERE event_type='resolution'` (0 ⇒ ausente; em 04/09 21:23Z passou a 1 — o primeiro da história do ledger); RFC-025: `count(*) FROM portfolio_circuit_breakers WHERE kind='PARAM_CHANGE' AND ended_at IS NULL`; RFC-022: status no repo |
