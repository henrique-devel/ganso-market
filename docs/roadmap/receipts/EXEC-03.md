...
Estado: code-verified; provas locais concluídas, publicação/CI em andamento.
Código: base18a6c20; branch codex/exec-03-fill-cancel, worktree /private/tmp/ganso-exec03.
...
Produção: não alterada nesta etapa; nenhum worker ativado.
