...
Estado: code-verified; implementação e contratos locais, publicação em andamento.
Código: alterações FIN-06 sobre base 33190a26a53f6f2eed44bbb5ad6fbcd9afa8d1f7.
...
Produção: ainda não verificada para esta release; nenhum resultado prospectivo/soak declarado.
