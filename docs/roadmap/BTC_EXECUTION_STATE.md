...
| [FIN-07](../../prompts/roadmap/btc/fin-07-reconciliacao-financeira.md) | code-verified | [Recibo](receipts/FIN-07.md): FIN-03/#187 corrigida; [PR197](https://github.com/henrique-devel/ganso-market/pull/197)/6279457 e reparo [PR199](https://github.com/henrique-devel/ganso-market/pull/199)/f2f5528 integrados; broker/cache/leitores por dono, v1 diagnóstico, schema26; PG18.4:319 passed (288SQL+31unit), zero skips,18 checkpoints/rebuild/retry/rollback e buckets exatos; make verify/CI/CD aprovados; SHAs/health/ready/configs/banco verificados em17/09; prontidão financeira local integral, sem conciliação histórica/soak/live; origem de sessão ociosa segue em OPS/RISK198 |
...
| [EXEC-04](../../prompts/roadmap/btc/exec-04-saidas-reduce-only.md) | code-verified | [Recibo](receipts/EXEC-04.md): D4-A long SELL/short BUY por dono/token, reserva/dedup/recusas; 250focados/279SQL+31unitários no gate PG sem skips e make verify aprovados; PR195/merge1f49f47, CI/CD e aplicação paper/portfolio no SHA verificados, banco preservado; produção0posições/sem fills novos ou soak; FIN-07 integral pendente; sem live; contrato para FRESH-03/EXEC-05 |
