...
| [FIN-06](../../prompts/roadmap/btc/fin-06-tokens-reais.md) | code-verified | [Recibo](receipts/FIN-06.md): PR #181/merge a61b5fe; decisão/ordem v2, BUY YES/NO com livro/bound reais; 479 focados/46 PG e make verify/CI/CD aprovados; release inicial no SHA/configs preservadas; reinícios portfolio/57014 observados, PR182/183 integrados, timeout de mids herdados persiste; reparo SQL isolado em validação; replay v1/short legado intactos; sem migration/caps/worker/EV final/D4 novos ou reconciliação produtiva/soak |
