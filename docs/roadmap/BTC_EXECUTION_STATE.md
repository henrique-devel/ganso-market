...
| [EXEC-04](../../prompts/roadmap/btc/exec-04-saidas-reduce-only.md) | code-verified | [Recibo](receipts/EXEC-04.md): D4-A long SELL/short BUY por dono/token, reserva/dedup/recusas; 250focados/310PG sem skips e make verify aprovados; PR195/merge1f49f47, CI/CD e aplicação paper/portfolio no SHA verificados, banco preservado; produção0posições/sem fills novos ou soak; FIN-07 integral pendente; sem live; contrato para FRESH-03/EXEC-05 |
