...
| [DB-03](../../prompts/roadmap/btc/db-03-rtds-e-livro-asof.md) | code-verified | [Recibo](receipts/DB-03.md): PR #158; candidato RTDS equivalente em PG18.4, 120k→2–4 linhas/8–16 buffers; 55 testes (46 PG); runtime preservado por buffers até 4,70× sem índice; escrita/WAL bloqueados pela revisão automática, promoção DB-04 pendente; Q4 adiado DB-03B (31,299 s ativo/68.333 linhas estimadas; contrato de empates/received-only), Q3 intacto |
| [DB-04](../../prompts/roadmap/btc/db-04-plano-recursos-e-validacao.md) | code-verified | [Recibo](receipts/DB-04.md): PR #159; especificação de capacidade/índices/rollback e seis abas (15min/teto2200), 12 verificações offline; observação passiva PG1CPU/1GiB e throttling91,72%, pools28/40; sem aplicação/aceite integrado/soak; escrita DB-02 reprovada/DB-03 bloqueada pela revisão automática, headroom e Q4/DB-03B pendentes; DATA-01 independente elegível |
| [DATA-01](../../prompts/roadmap/btc/data-01-inventario-capacidade.md) | production-verified | [Recibo](receipts/DATA-01.md): PR #160; inventário read-only 12/09 UTC, 79 tabelas/200 índices; físico92,226GiB/vivo estimado67,991GiB, disco livre62,121%; quotas já pressionam cobertura, PG throttling98,734%; ledger guard confirmado/orders sem proteção por status; Solana vazio no snapshot; relatório/candidatos/projeções e fecho lógico para DATA-02; sem proteção/export/poda/tuning/soak |
| [DATA-02](../../prompts/roadmap/btc/data-02-protecao-e-manifesto.md) | code-verified | [Recibo](receipts/DATA-02.md): PR #161; HOLD69 evidências+4 resíduos, guards/pins transacionais e manifesto dry-run limitado;2313 source passed/191 skipped e26 PG reais; quota não libera proteção, exposição encerrada zerada sem DELETE; classificação0xsonda central; aplicação/ciclos produção pendentes; sem poda/export/soak; horizontes/pins finos e gates herdados pendentes |
