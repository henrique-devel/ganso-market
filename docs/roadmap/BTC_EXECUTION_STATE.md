...
| [FIN-06](../../prompts/roadmap/btc/fin-06-tokens-reais.md) | code-verified | [Recibo](receipts/FIN-06.md): decisão/ordem v2, BUY YES/NO com livro real e bound próprio; 999295c; 479 testes focados/46 PG reais e make verify passaram; donos isolados/SELL limitado/replay v1; sem migration/caps/worker/EV final/D4 novos; publicação via PR autorizada diretamente em 16/09 UTC, em andamento |
