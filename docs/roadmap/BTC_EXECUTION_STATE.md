...
| [FIN-07](../../prompts/roadmap/btc/fin-07-reconciliacao-financeira.md) | code-verified | [Recibo](receipts/FIN-07.md): correção FIN-03/#187 em a03490c; broker/cache/leitores financial-v2 por dono, v1 diagnóstico explícito, migration0026/âncoras separadas; QA-01/PG18.4, 318 passaram (287SQL+31unit), zero skips; F1–F6/18 checkpoints broker, reservas/retry/restart/rollback e buckets UTC exatos; make verify aprovado; prontidão financeira local integral, sem histórico produtivo/soak/live; publicação/implantação no fecho |
