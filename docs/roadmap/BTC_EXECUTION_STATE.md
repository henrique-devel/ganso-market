...
| [EXEC-02](../../prompts/roadmap/btc/exec-02-ev-da-ordem-final.md) | code-verified | [Recibo](receipts/EXEC-02.md): base e400a70, final-entry-v1/ordem v3; EV comum após normalização e antes da reserva, dono/token/livro/fee e auditoria append-only; 297 focados/293 PG reais, make verify passou; livro raso, recotação, fee null e EV insuficiente recusam; sem expiry/D4/caps/live; publicação/produção pendentes |
