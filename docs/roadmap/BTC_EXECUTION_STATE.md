...
| [FIN-05](../../prompts/roadmap/btc/fin-05-reservas-atomicas.md) | code-verified | [Recibo](receipts/FIN-05.md): reservation-v1/0025, aceite+dono atômicos, cash/risco/inventário, consume/release/restart; 237 testes focados (45 PG reais), disputa US$600+US$500/US$1.000 com lock observado; make verify passou; publicação/produção pendentes, sem caps/validade/live novos; contrato EXEC-03/04 entregue |
