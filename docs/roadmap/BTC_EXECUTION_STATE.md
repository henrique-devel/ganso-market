...
| [EXEC-04](../../prompts/roadmap/btc/exec-04-saidas-reduce-only.md) | code-verified | [Recibo](receipts/EXEC-04.md): código3673bca/base92b1003; D4-A long SELL/short BUY por dono/token, reservas/dedup/recusas persistidas; 250focados/310PG reais sem skips e make verify passaram; seis arquivos/sem migration; FIN-07 integral pendente, sem live/soak; publicação/aplicação pendentes; contrato para FRESH-03/EXEC-05 |
