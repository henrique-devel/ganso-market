...
| [FIN-04](../../prompts/roadmap/btc/fin-04-exposicao-por-payoff.md) | code-verified | [Recibo](receipts/FIN-04.md): código b68e6de; payoff/dono, short/fees e soma conservadora sem max-negRisk; cenários completos restritos ao contrato/dono/bucket; 116 testes (9 PG), make verify aprovado; caps preservados, sem reservas; contrato FIN-05 documentado; publicação pendente |
