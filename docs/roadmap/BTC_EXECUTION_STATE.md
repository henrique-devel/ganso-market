...
| [DATA-01](../../prompts/roadmap/btc/data-01-inventario-capacidade.md) | code-verified | [Recibo](receipts/DATA-01.md): inventário histórico PR #160 preservado; retomada implementa série finita8amostras/7intervalos via watchdog existente,FS real deduplicado/DB/WAL,read-only1500ms/sem retry;115testes e contratoPG18.4 local passam; instalação/primeira amostra pendentes;7dias e crescimento sustentado não comprovados;HOLD/imagens/backups/rollback preservados,sem poda/tuning/soak |
