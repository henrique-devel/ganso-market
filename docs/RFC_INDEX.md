...
| [RFC-021](rfcs/RFC-021-silencio-do-feed-e-kill-switch.md)           | Silêncio do feed com conexões vivas e kill switch honesto | RFC-007, RFC-011, RFC-020        | parada silenciosa do WS vira lacuna `stream_silent`; gatilho lê deltas e snapshots e diz qual série calou; `closed` reflete a venue — **accepted (2026-09-04)**; **todas** as decisões aprovadas em 2026-09-05, **incluindo a D3** (rearme automático condicionado, `M` = 15 min), que supersede a cláusula de rearme manual da RFC-011. Segue com o proprietário só o rearme à mão do switch engatado hoje |
