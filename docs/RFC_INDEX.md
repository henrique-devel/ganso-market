...
| [RFC-010](rfcs/RFC-010-polymarket-fundamental-model.md)    | Modelo fundamental (`q` + incerteza)        | RFC-007                    | estimativas calibradas por categoria (crypto, macro agendado)                         |
| [RFC-011](rfcs/RFC-011-polymarket-microstructure-paper.md) | Microestrutura e paper broker               | RFC-007 e RFC-010          | timing/tipo de ordem e simulação realista com custos V2                               |
