...
**Status:** accepted — autorizado para implementação (2026-09-04); P1–P4 aprovadas no default (2026-09-05)
...
> cada uma **no default listado**. Não há decisão pendente nesta RFC.
